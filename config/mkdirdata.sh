...
build_pm_folder MS
build_pm_folder NF
build_pm_folder PMFFT

#-----------------------------------------------------------------------------------------
# plot folder
#-----------------------------------------------------------------------------------------
#QBCP
mkdir -p plot/QBCP/EM/L1/orbits
mkdir -p plot/QBCP/EM/L2/orbits

mkdir -p plot/QBCP/SEM/L1/orbits
mkdir -p plot/QBCP/SEM/L2/orbits

# CRTBP
mkdir -p plot/CRTBP/EM/L1/orbits
mkdir -p plot/CRTBP/EM/L2/orbits

mkdir -p plot/CRTBP/SEM/L1/orbits
mkdir -p plot/CRTBP/SEM/L2/orbits
